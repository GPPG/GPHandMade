...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:ClickPhoto object:nil];
    ...
    if (targetTemp.size.width == 0 && targetTemp.size.height == 0) {
        targetTemp = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT * 0.25);
    }
